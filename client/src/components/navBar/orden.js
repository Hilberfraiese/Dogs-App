  ...
  return (
    <div className={estilo.container}>
      <div>
        ...
        <button className={estilo.button} onClick={(e) => orderAsc(e)}>
          A-Z
        </button>
        <button className={estilo.button} onClick={(e) => orderDes(e)}>
          Z-A
        </button>
      </div>
      ...
      <div>
        ...
        <button className={estilo.button2} onClick={(e) => orderLight(e)}>
          Weight - to +
        </button>
        <button className={estilo.button2} onClick={(e) => orderHeavy(e)}>
          Weight + to -
        </button>
      </div>
      ...
      <div>
        <form onSubmit={handleSubmit}>
          <label className={estilo.label}>Filter by temps </label>
          <br />
          <select
          ...
          <button type="submit" className={estilo.button2}>
            {" "}
            Filter
          </button>
        </form>
